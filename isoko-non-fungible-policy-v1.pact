(module isoko-non-fungible-policy-v1 GOVERNANCE
    ...
    (defun enforce-init:bool
      ...
      (require-capability (INIT-CALL (at "id" token) (at "precision" token) (at "uri" token) isoko-non-fungible-policy-v1))
    ...
    (defun enforce-mint:bool
      ...
      (require-capability (MINT-CALL (at "id" token) account amount isoko-non-fungible-policy-v1))
