(namespace "n_f1c962776331c4773136dc1587a8355c9957eae1")
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ...
  (defun create-collection (policies:[module{kip.token-policy-v2}])
  ...
  (defun create-nft-token-v2:string(collection-id:string policies:[module{kip.token-policy-v2}] creator-guard:guard spec:object)
    ...
    (let*
      (
        (uri-obj (at "uri" spec))
        (uri (at "data" uri-obj))
        (token-details (create-token-details uri 0 policies))
  ...
  (defun create-token-details (uri:string precision:integer policies:[module{kip.token-policy-v2}])
    {
        "uri": uri,
        "precision": precision,
        "policies": policies
...
(defun mint-generic(owner:string guard:guard token-id:string)
    (install-capability (marmalade-v2.ledger.MINT token-id owner 1.0))
    (marmalade-v2.ledger.mint token-id owner guard 1.0)
  )
