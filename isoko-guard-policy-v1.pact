(module isoko-guard-policy-v1 GOVERNANCE
    ...
    (defun enforce-init:bool
      ...
      \ the created token"
      ; (require-capability (INIT-CALL (at "id" token) (at "precision" token) (at "uri" token) isoko-guard-policy-v1))
    ...
    (defun enforce-mint:bool
      ...
      ; (require-capability (MINT-CALL (at "id" token) account amount isoko-guard-policy-v1))
    ...
    (defun enforce-burn:bool
      ...
      ; (require-capability (BURN-CALL (at "id" token) account amount isoko-guard-policy-v1))
    ...
    (defun enforce-offer:bool
      ( token:object{token-info}
        ...
        timeout:integer
        sale-id:string )
      ; (require-capability (OFFER-CALL (at "id" token) seller amount sale-id timeout isoko-guard-policy-v1))
    ...
    (defun enforce-buy:bool
      ( token:object{token-info}
        ...
        amount:decimal
        sale-id:string )
      ; (require-capability (BUY-CALL (at "id" token) seller buyer amount sale-id isoko-guard-policy-v1))
      ; (enforce-sale-pact sale-id)
      ; (with-capability (SALE (at 'id token) seller amount)
        true
      ; )
    ...
    (defun enforce-withdraw:bool
      ( token:object{token-info}
        ...
        timeout:integer
        sale-id:string )
      ; (require-capability (WITHDRAW-CALL (at "id" token) seller amount sale-id timeout isoko-guard-policy-v1))
      ; (enforce-sale-pact sale-id)
      ; (with-capability (SALE (at 'id token) seller amount)
        true
      ; )
    ...
    (defun enforce-transfer:bool
      ( token:object{token-info}
        ...
        receiver:string
        amount:decimal )
      ; (require-capability (TRANSFER-CALL (at "id" token) sender receiver amount isoko-guard-policy-v1))
