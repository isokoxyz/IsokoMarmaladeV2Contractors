(module isoko-royalty-policy-v1 GOVERNANCE
    ...
    (defun enforce-init:bool
      ...
      \ the created token"
      (require-capability (INIT-CALL (at "id" token) (at "precision" token) (at "uri" token) isoko-royalty-policy-v1))
    ...
    (defun enforce-offer:bool
      ...
      (require-capability (OFFER-CALL (at "id" token) seller amount sale-id timeout isoko-royalty-policy-v1))
    ...
    (defun enforce-buy:bool
      ( token:object{token-info}
        ...
        sale-id:string )
      (enforce false "not enabled")
      (require-capability (BUY-CALL (at "id" token) seller buyer amount sale-id isoko-royalty-policy-v1))
